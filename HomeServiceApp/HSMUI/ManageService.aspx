            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form class="form-horizontal col-sm-8" style="margin-top: 50px;">
                    <div class="form-group">
                        <label for="serviceName" class="col-sm-4 control-label">Change Service Name</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="serviceNameTxt" class="col-sm-4 control-label">Service Name</label>
                        <div class="col-sm-6">
                            <input class="form-control" id="serviceNameTxt" name="serviceNameTxt" placeholder="Service Name" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-5">
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" id="serviceActive" name="serviceStatus" value="1" />
                                    Service Active
                                </label>
                            </div>
                            <div class="radio-inline">
